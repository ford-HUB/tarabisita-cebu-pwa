...
const ExpandedOrdersPanel = ({
  ...
  return (
    <div className="min-h-[520px] overflow-hidden rounded-lg border border-[#ecdfd1] bg-white">
      <div className="grid gap-2 border-b border-[#f0e4d7] bg-[#fffdf8] p-3 md:grid-cols-2">
      ...
      <div className="grid grid-cols-[1fr_1.6fr_1.2fr_0.8fr_0.9fr_0.9fr_0.9fr] gap-2 border-b border-[#f0e4d7] bg-[#fff7ee] px-3 py-2 text-xs font-semibold text-[#7d5b3b]">
        <span>Order ID</span>
        <span>Product</span>
        <span>Customer</span>
        <span>Items</span>
      ...
      <div className="max-h-[420px] overflow-y-auto">
        <div className="divide-y divide-[#f2e8dc]">
          {filteredOrders.map((order) => (
            ...
            >
              <span className="font-semibold text-[#7d5b3b]">{order.id}</span>
          ...
          {filteredOrders.length === 0 ? (
            <div className="px-3 py-8 text-center text-sm text-[#8f8377]">No matching orders found.</div>
          ) : null}
        </div>
      </div>
    </div>
